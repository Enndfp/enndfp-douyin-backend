...
public interface VlogMapper extends BaseMapper<Vlog> {
    ...
    Page<VlogVO> queryMyVlogList(Page<VlogVO> page, @Param("paramMap") Map<String, Object> map);

    Page<VlogVO> getMyLikedVlogList(Page<VlogVO> page, @Param("paramMap") Map<String, Object> map);

    Page<VlogVO> getMyFollowVlogList(Page<VlogVO> page, @Param("paramMap") Map<String, Object> map);

    Page<VlogVO> getMyFriendVlogList(Page<VlogVO> page, @Param("paramMap") Map<String, Object> map);

...
public enum ErrorCode {
    ...
    VLOG_PUBLISH_FAILED(515, "视频发布失败！"),
    VLOG_IS_NOT_EXIST(516, "视频不存在！"),
    FOLLOW_FAILED(517, "关注失败，请稍后再试！"),
    NOT_ALLOWED_FOLLOW_YOURSELF(518, "不允许关注自己！"),
    CANCEL_FOLLOW_FAILED(519, "取消关注失败，请稍后再试！"),
    NOT_FOLLOW(520, "您未关注对方！"),
    ALREADY_FOLLOW(521, "您已关注对方！"),
    LIKE_FAILED(522, "点赞失败！"),
